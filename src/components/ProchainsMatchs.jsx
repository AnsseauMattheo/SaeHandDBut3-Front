            ...
            <CardContent className="space-y-3">
                {matchs.length === 0 ? (
                    ...
                    matchs.map((match, index) => (
                        <div
                            key={index}
                            className="flex flex-col gap-3 p-4 border border-neutral-200 rounded-lg hover:shadow-md transition-shadow bg-white"
                        >
                            {/* Date + Heure en haut sur mobile, à gauche sur desktop */}
                    ...
                    {match.domExterieur}
                                    ...
                                    {match.salle && (
                                        <div className="flex items-center gap-1 text-xs text-neutral-500">
                                            ...
                                            <span className="truncate max-w-[120px] sm:max-w-[80px]">{match.salle}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2 sm:gap-3">
                                ...
                                <span className="font-bold text-neutral-400 text-base sm:text-lg px-1 sm:px-2">VS</span>
