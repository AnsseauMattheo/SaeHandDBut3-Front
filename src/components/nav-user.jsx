...
import { ParametreDialog } from "@/components/Parametre"
    ...
    if (userinfo) {
        return (
            <>
                    ...
                    <SidebarMenuItem>
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <SidebarMenuButton
                                    ...
                                    <div className="grid flex-1 text-left text-sm leading-tight">
                                        ...
                                        <span className="truncate text-xs">{userinfo.mail}</span>
                                    </div>
                            ...
                            <DropdownMenuContent
                                ...
                                <DropdownMenuSeparator/>
                                <DropdownMenuGroup>
                                    <DropdownMenuItem onClick={handleParametres}>
                                        <Settings />
                                        Paramètre
                                    </DropdownMenuItem>
                                </DropdownMenuGroup>
                ...
                <ParametreDialog
                    isOpen={isParametreOpen}
                    onClose={() => setIsParametreOpen(false)}
                />
            </>
        )
    }
